...
#
#  Rich Trouton (http://github.com/rtrouton)
#  Adding correct values for 10.13 beta 8
#  Adding correct values for 10.13 beta 9
#
...
#
url="https://swdist.apple.com/content/downloads/03/31/${key}/4w5tzainc57sapbvui8ipmws8tf7urny87/"
